        ...
        proceedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedSubject != null && !selectedSubject.isEmpty() && selectedDate != null) {
                    Intent intent = new Intent(MarkAttendanceActivity.this, StudentAttendanceActivity.class);
                    intent.putExtra("selectedSubject", selectedSubject);
                    intent.putExtra("teacherUID", teacherUID);
                    intent.putExtra("selectedDate", selectedDate);
                    startActivity(intent);
                    Log.d("MarkAttendanceActivity", "Proceeding with subject: " + selectedSubject + " and date: " + selectedDate);
                } else {
                    Toast.makeText(MarkAttendanceActivity.this, "Please select a subject and date", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void loadSubjects() {
        subjectsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("MarkAttendanceActivity", "Database error: " + databaseError.getMessage());
                Toast.makeText(MarkAttendanceActivity.this, "Failed to load subjects.", Toast.LENGTH_SHORT).show();
            }
        });
    }
